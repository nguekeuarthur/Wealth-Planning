  ...
  FR: {
    ...
    servicesIntro: {
      ...
      paragraphs: [
        ...
        "De la création à la transmission, nous vous accompagnons sur l'ensemble du cycle patrimonial. Nous prenons en charge toutes vos démarches administratives et bancaires (création d’entreprise, domiciliation, ouverture de compte), et vous conseillons de manière intégrée sur l’optimisation de votre patrimoine et sa transmission.",
      ],
      cta: "En savoir plus",
    },
    steps: {
