...
export const API_PATHS = {
  ...
  WEEKLY_UPDATES: {
    GET_ALL_UPDATES: "/api/weekly-updates",
    GET_PROJECT_UPDATES: (projectId) => `/api/weekly-updates/project/${projectId}`,
  ...
  MILESTONES: {
    GET_PROJECT_MILESTONES: (projectId) => `/api/milestones/project/${projectId}`,
