...
const { getUsers, getUserById, createUser, updateUser, deleteUser, deleteOwnAccount, getDeletedUsers, getCompanyNames, cleanupDeletedUsers, searchUsers, searchUsersForChat, getAllUsersDebug, seedUsers } = require("../controllers/userController");
...
router.get("/search/chat", protect, searchUsersForChat); // Search users for chat (filtered by permissions)
...
router.delete("/me", protect, deleteOwnAccount); // Delete own account (Authenticated users)
